...
public final class ActionMapper {
    ...
    public void installDefaultKeyboardBindings() {
        ...
        bind(Action.OPEN_CHAT, rt4.amilious.input.state.InputButtons.GP_A, InputMode.WORLD);
        bind(Action.SUBMIT_CHAT, rt4.amilious.input.state.InputButtons.ENTER, InputMode.CHAT);
        bind(Action.SUBMIT_CHAT, rt4.amilious.input.state.InputButtons.GP_A, InputMode.CHAT);
