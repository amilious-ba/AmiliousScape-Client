...
public final class WaterMaterialRenderer implements MaterialRenderer {
	...
	private void method3435() {
		...
		GlRenderer.api.glGenTextures(1, local15, 0);
		GlRenderer.api.glBindTexture(GL2.GL_TEXTURE_1D, local15[0]);
		GlRenderer.api.glTexImage1D(GL2.GL_TEXTURE_1D, 0, GL2.GL_ALPHA, 2, 0, GL2.GL_ALPHA, GL2.GL_UNSIGNED_BYTE, ByteBuffer.wrap(local2));
	...
	private void method3437() {
		this.anInt4440 = GlRenderer.api.glGenLists(2);
		GlRenderer.api.glNewList(this.anInt4440, GL2.GL_COMPILE);
		GlRenderer.api.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_OPERAND0_RGB, GL2.GL_SRC_COLOR);
		GlRenderer.api.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_SRC1_RGB, GL2.GL_CONSTANT);
		GlRenderer.api.glTexEnvf(GL2.GL_TEXTURE_ENV, GL2.GL_RGB_SCALE, 2.0F);
		GlRenderer.api.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2GL3.GL_SRC1_ALPHA, GL2.GL_CONSTANT);
		GlRenderer.api.glTexGeni(GL2.GL_S, GL2.GL_TEXTURE_GEN_MODE, GL2.GL_OBJECT_LINEAR);
		GlRenderer.api.glTexGeni(GL2.GL_T, GL2.GL_TEXTURE_GEN_MODE, GL2.GL_OBJECT_LINEAR);
		GlRenderer.api.glTexGenfv(GL2.GL_S, GL2.GL_OBJECT_PLANE, new float[]{9.765625E-4F, 0.0F, 0.0F, 0.0F}, 0);
		GlRenderer.api.glTexGenfv(GL2.GL_T, GL2.GL_OBJECT_PLANE, new float[]{0.0F, 0.0F, 9.765625E-4F, 0.0F}, 0);
		...
		GlRenderer.api.glBindTexture(GL2.GL_TEXTURE_1D, this.anInt4441);
		...
		GlRenderer.api.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_COMBINE_ALPHA, GL2.GL_INTERPOLATE);
		GlRenderer.api.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_SRC0_ALPHA, GL2.GL_CONSTANT);
		GlRenderer.api.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_SRC2_ALPHA, GL2.GL_TEXTURE);
		GlRenderer.api.glEnable(GL2.GL_TEXTURE_GEN_S);
		...
		GlRenderer.api.glNewList(this.anInt4440 + 1, GL2.GL_COMPILE);
		GlRenderer.api.glActiveTexture(GL2.GL_TEXTURE1);
		...
		GlRenderer.api.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_SRC2_ALPHA, GL2.GL_CONSTANT);
		...
		GlRenderer.api.glTexEnvf(GL2.GL_TEXTURE_ENV, GL2.GL_RGB_SCALE, 1.0F);
		GlRenderer.api.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2GL3.GL_SRC1_ALPHA, GL2.GL_PREVIOUS);
		GlRenderer.api.glDisable(GL2.GL_TEXTURE_GEN_S);
	...
	public final void unbind() {
		GlRenderer.api.glCallList(this.anInt4440 + 1);
	}
	...
	public final void setArgument(@OriginalArg(0) int arg0) {
		GlRenderer.api.glActiveTexture(GL2.GL_TEXTURE1);
		GlRenderer.api.glTexEnvfv(GL2.GL_TEXTURE_ENV, GL2.GL_TEXTURE_ENV_COLOR, aFloatArray2, 0);
		GlRenderer.api.glActiveTexture(GL2.GL_TEXTURE0);
		if ((arg0 & 0x1) == 1) {
			if (!MaterialManager.allows3DTextureMapping) {
				...
				GlRenderer.api.glTexGenfv(GL2.GL_R, GL2.GL_OBJECT_PLANE, this.aFloatArray23, 0);
	...
	public final void bind() {
		...
		GlRenderer.api.glCallList(this.anInt4440);
		...
		GlRenderer.api.glTexGenfv(GL2.GL_S, GL2.GL_EYE_PLANE, this.aFloatArray23, 0);
		GlRenderer.api.glPopMatrix();
		GlRenderer.api.glActiveTexture(GL2.GL_TEXTURE0);
		GlRenderer.api.glTexEnvfv(GL2.GL_TEXTURE_ENV, GL2.GL_TEXTURE_ENV_COLOR, aFloatArray22, 0);
	}
