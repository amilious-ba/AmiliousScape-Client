...
public final class GlRaster {
	...
	public static void method1174(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		GlRenderer.api.glBegin(GL2.GL_LINES);
		GlRenderer.api.glColor3ub((byte) (arg3 >> 16), (byte) (arg3 >> 8), (byte) arg3);
		GlRenderer.api.glVertex2f(local5, local18);
		GlRenderer.api.glVertex2f(local10, local18);
	...
	public static void method1176(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		GlRenderer.api.glBegin(GL2.GL_LINES);
		GlRenderer.api.glColor3ub((byte) (arg3 >> 16), (byte) (arg3 >> 8), (byte) arg3);
		GlRenderer.api.glVertex2f(local5, local13);
		GlRenderer.api.glVertex2f(local5, local18);
		GlRenderer.api.glEnd();
	}
	...
	public static void method1177() {
		...
		GlRenderer.api.glDisable(GL2.GL_SCISSOR_TEST);
		GlFont.method1173();
	}
	...
	public static void drawPixels(@OriginalArg(0) int[] arg0, @OriginalArg(1) int x, @OriginalArg(2) int y, @OriginalArg(3) int width, @OriginalArg(4) int height) {
		GlRenderer.method4162();
		GlRenderer.api.glRasterPos2i(x, GlRenderer.canvasHeight - y);
		GlRenderer.api.glPixelZoom((float) GameShell.canvasScale, (float) -GameShell.canvasScale);
		GlRenderer.api.glDisable(GL2.GL_BLEND);
		GlRenderer.api.glDisable(GL2.GL_ALPHA_TEST);
		GlRenderer.api.glDrawPixels(width, height, GL2.GL_BGRA, GlRenderer.bigEndian ? GL2.GL_UNSIGNED_INT_8_8_8_8_REV : GL2.GL_UNSIGNED_BYTE, IntBuffer.wrap(arg0));
		GlRenderer.api.glPixelZoom(1.0F, 1.0F);
		GlRenderer.api.glEnable(GL2.GL_ALPHA_TEST);
		GlRenderer.api.glEnable(GL2.GL_BLEND);
	}
	...
	public static void drawRect(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		GlRenderer.api.glBegin(GL2.GL_LINE_LOOP);
		GlRenderer.api.glColor3ub((byte) (arg4 >> 16), (byte) (arg4 >> 8), (byte) arg4);
		GlRenderer.api.glVertex2f(local5, local20);
		GlRenderer.api.glVertex2f(local5, local27);
		GlRenderer.api.glVertex2f(local12, local27);
		GlRenderer.api.glVertex2f(local12, local20);
		GlRenderer.api.glEnd();
	}
	...
	public static void method1180(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		@Pc(27) float local27 = local20 - (float) (arg3 - 1);
		GlRenderer.api.glBegin(GL2.GL_LINE_LOOP);
		GlRenderer.api.glColor4ub((byte) (arg4 >> 16), (byte) (arg4 >> 8), (byte) arg4, arg5 > 255 ? -1 : (byte) arg5);
		GlRenderer.api.glVertex2f(local5, local20);
		GlRenderer.api.glVertex2f(local5, local27);
		GlRenderer.api.glVertex2f(local12, local27);
		GlRenderer.api.glVertex2f(local12, local20);
	...
	public static void method1181(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (local43 <= local37) {
			GlRenderer.api.glVertex2f((float) local101, (float) (GlRenderer.canvasHeight - local121));
			GlRenderer.api.glVertex2f((float) local95, (float) (GlRenderer.canvasHeight - local115));
			GlRenderer.api.glVertex2f((float) local89, (float) (GlRenderer.canvasHeight - local109));
			GlRenderer.api.glVertex2f((float) local85, (float) (GlRenderer.canvasHeight - local105));
		} else {
			GlRenderer.api.glVertex2f((float) local85, (float) (GlRenderer.canvasHeight - local105));
			GlRenderer.api.glVertex2f((float) local89, (float) (GlRenderer.canvasHeight - local109));
			GlRenderer.api.glVertex2f((float) local95, (float) (GlRenderer.canvasHeight - local115));
	...
	public static void fillRectAlpha(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		GlRenderer.api.glBegin(GL2.GL_TRIANGLE_FAN);
		GlRenderer.api.glColor4ub((byte) (arg4 >> 16), (byte) (arg4 >> 8), (byte) arg4, arg5 > 255 ? -1 : (byte) arg5);
		GlRenderer.api.glVertex2f(local3, local13);
		GlRenderer.api.glVertex2f(local3, local18);
		GlRenderer.api.glVertex2f(local8, local18);
		GlRenderer.api.glVertex2f(local8, local13);
		GlRenderer.api.glEnd();
	}
	...
	public static void method1183(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		GlRenderer.api.glEnable(GL2.GL_SCISSOR_TEST);
		if (clipLeft <= clipRight && clipTop <= clipBottom) {
			GlRenderer.api.glScissor((int) (clipLeft * GameShell.canvasScale + GameShell.subpixelX), (int) ((GlRenderer.canvasHeight - clipBottom) * GameShell.canvasScale + GameShell.subpixelY), (int) ((clipRight - clipLeft) * GameShell.canvasScale + GameShell.subpixelX), (int) ((clipBottom - clipTop) * GameShell.canvasScale + GameShell.subpixelY));
		} else {
			GlRenderer.api.glScissor(0, 0, 0, 0);
		}
		GlFont.method1173();
	}
	...
	public static void clear() {
		GlRenderer.api.glClear(GL2.GL_DEPTH_BUFFER_BIT | GL2.GL_COLOR_BUFFER_BIT);
	}
	...
	public static void method1185(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		GlRenderer.api.glColor3ub((byte) (arg4 >> 16), (byte) (arg4 >> 8), (byte) arg4);
		GlRenderer.api.glVertex2f(local5, local18);
		GlRenderer.api.glVertex2f(local10, local26);
		GlRenderer.api.glEnd();
	}
